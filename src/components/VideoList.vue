          ...
          <div class="hidden w-full md:block md:w-auto" id="navbar-default">
            <ul
              ...
              <li v-for="category in categories" :key="category.id" @click="changeCategoryId(category)">
                <a href="#"
                  class="mya text-white block py-2 pl-3 pr-4 text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">{{
                    category }}</a>
              </li>
            </ul>
          </div>
